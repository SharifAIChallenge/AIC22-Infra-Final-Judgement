...
(cd /tmp/match && movementLogThresholdTimeMillisecond=3000 clientReadinessThresholdTimeMillisecond=60000 magicTurnTime=2000 java -jar /usr/local/match/match.jar $@)
