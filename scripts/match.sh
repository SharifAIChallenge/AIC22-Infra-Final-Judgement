...
(cd /tmp/match && movementLogThresholdTimeMillisecond=2500 clientReadinessThresholdTimeMillisecond=60000 magicTurnTime=2000 java -jar /usr/local/match/match.jar $@)
